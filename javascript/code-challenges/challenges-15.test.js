...
const detectTicTacToeWin = (board) => {
  const toCheck = (row1, col1, row2, col2, row3, col3) => {
    let output;
    if (board[row1][col1] === board[row2][col1] && board[row1][col1] === board[row3][col1]){
      output = true;
    } else if (board[row1][col2] === board[row2][col2] && board[row1][col2] === board[row3][col2]){
      output =  true;
    } else if (board[row1][col3] === board[row2][col3] && board[row1][col3] === board[row3][col3]){
      output =  true;
    } else if (board[row1][col1] === board[row2][col2] && board[row1][col1] === board[row3][col3]){
      output =  true;
    } else if (board[row1][col3] === board[row2][col3] && board[row1][col3] === board[row3][col1]){
      output =  true;
    } else if (board[row2][col1] === board[row2][col2] && board[row2][col1] === board[row2][col3]){
      output =  true;
    } else if (board[row3][col1] === board[row3][col2] && board[row3][col1] === board[row3][col3]){
      output =  true;
    } else {
      output =  false;
    }
